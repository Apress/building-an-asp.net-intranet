...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Page.IsPostBack = False Then
                ...
                If itemId <> 0 Then
                    ...
                    Dim dr As SqlDataReader = SkillsBiz.GetSingleSkill(itemId)
        ...
        ' create or update a Skill.  It  uses the ASPNetPortal.SkillsBiz()
            ...
            If Page.IsValid = True Then
                Try
                    If itemId = 0 Then
                        ...
                        SkillsBiz.AddSkill(DescriptionField.Text)

                    Else

                        ' Update the Skill within the skills table
                        SkillsBiz.UpdateSkill(itemId, DescriptionField.Text)
        ...
        ' skill.  It  uses the ASPNetPortal.SkillsBiz
        ' data component to encapsulate all data functionality.
        '
        '****************************************************************
