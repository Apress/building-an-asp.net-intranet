...
Namespace ASPNetPortal
    ...
    Public Class EventsDB
        ...
        Public Function GetMonthlyEvents(ByVal moduleId As Integer, _
            ...
            ' Load the Parameters
            params(0) = dataCon.MakeParameter("@ModuleID", moduleId)

            params(1) = dataCon.MakeParameter("@ShowDate", showDate)

            params(2) = dataCon.MakeParameter("@CurrentDate", DateTime.Today)
        ...
        Public Function GetAllEvents(ByVal moduleId As Integer) As DataSet
            ...
            params(1) = dataCon.MakeParameter("@CurrentDate", DateTime.Today)
        ...
        Public Function GetSingleEvent(ByVal moduleId As Integer, _
            ...
            params(0) = dataCon.MakeParameter("@ItemID", itemId)

            params(1) = dataCon.MakeParameter("@ModuleID", moduleId)
        ...
        Public Function AddEvent(ByVal moduleId As Integer, ByVal itemId As Integer, ByVal userName As String, ByVal title As String, ByVal eventDate As DateTime, ByVal description As String, ByVal wherewhen As String, ByVal viewRoles As String)
            ...
            params(1) = dataCon.MakeParameter("@UserName", userName)

            params(2) = dataCon.MakeParameter("@Title", title)

            params(3) = dataCon.MakeParameter("@WhereWhen", wherewhen)

            params(4) = dataCon.MakeParameter("@ViewRoles", viewRoles)

            params(5) = dataCon.MakeParameter("@EventDate", eventDate)

            params(6) = dataCon.MakeParameter("@Description", description)
